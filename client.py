...
optional arguments:
  ...
  --gui           generate client controllable via web browser GUI at https://BabyServer.com
...
# modules
from BabyServer.core import util
from BabyServer.core import security 
from BabyServer.core import generators
...
def main(*args, **kwargs):
    ...
    if not kwargs:
        ...
        parser.add_argument('--gui',
                            action='store_true',
                            help='generate client controllable via web browser GUI at https://BabyServer.com',
                            default=False)
...
def _modules(options, **kwargs):
    ...
    modules =["./BabyServer/"+ i for i in modules]
